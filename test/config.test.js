...
test("parseConfig: nullish input does not throw (regression)", () => {
  // Regression: parseConfig previously called text.split(...) without
  // guarding, which threw a TypeError on null/undefined inputs.
